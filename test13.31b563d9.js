...
var _changeDataInBlancJs = require("./operation/changeDataInBlanc.js");
var _buildTabelJs = require("./build/buildTabel.js");
var _dropDownJs = require("./openClose/dropDown.js");
var _tableJs = require("./openClose/table.js");
var _renewaInputBadgeJs = require("./operation/renewaInputBadge.js");
var _changeToggleGroupJs = require("./operation/changeToggleGroup.js");
...
function renderInitialResults() {
    ...
    (0, _changeDataInBlancJs.changeDataInBlanc)(result);
    (0, _buildTabelJs.buildTable)(result.yearlyHistory);
}
function loadChart() {
    if (!chartModulePromise) chartModulePromise = require("99f3c924e105ae2");
...
},{"./data/compliteDataToCanculate.js":"aNWHP","./operation/calculateResult.js":"hWafh","./operation/changeDataInBlanc.js":"fzkr2","./build/buildTabel.js":"l1Es6","./openClose/dropDown.js":"TFunB","./openClose/table.js":"jkSUj","./operation/renewaInputBadge.js":"Zn6Xe","./operation/changeToggleGroup.js":"ifLxv","99f3c924e105ae2":"l9oaf"}],"aNWHP":[function(require,module,exports,__globalThis) {
...
},{}],"hWafh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function calculated(object) {
    ...
    const withInflation = inflationDivider === 0 ? accountBalancePostTax : accountBalancePostTax / inflationDivider;
    return {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fzkr2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "changeDataInBlanc", ()=>changeDataInBlanc);
var _i18NJs = require("./i18n.js");
function changeDataInBlanc(changetData) {
    ...
    if (totalBalance) totalBalance.textContent = (0, _i18NJs.formatNumber)(changetData.accountBalance);
    if (totalBalanceWhithTax) totalBalanceWhithTax.textContent = (0, _i18NJs.formatNumber)(changetData.accountBalancePostTax);
    if (taxPaid) taxPaid.textContent = (0, _i18NJs.formatNumber)(changetData.taxPaid);
    if (totalContributione) totalContributione.textContent = (0, _i18NJs.formatNumber)(changetData.totalContribution);
    if (totalInterest) totalInterest.textContent = (0, _i18NJs.formatNumber)(changetData.totalInterest);
    if (totalBalanceWhithTaxAndInflation) totalBalanceWhithTaxAndInflation.textContent = (0, _i18NJs.formatNumber)(changetData.withInflation);
}

},{"./i18n.js":"81Dku","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"81Dku":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "currentLengues", ()=>currentLengues);
parcelHelpers.export(exports, "formatNumber", ()=>formatNumber);
parcelHelpers.export(exports, "changeSiteLanguage", ()=>changeSiteLanguage);
...
var _buildTabel = require("../build/buildTabel");
var _compliteDataToCanculateJs = require("../data/compliteDataToCanculate.js");
var _calculateResultJs = require("./calculateResult.js");
// Імпортуємо файли перекладів
var _ukJson = require("../../langues/uk.json");
var _ukJsonDefault = parcelHelpers.interopDefault(_ukJson);
var _enJson = require("../../langues/en.json");
var _enJsonDefault = parcelHelpers.interopDefault(_enJson);
let currentLengues;
function formatNumber(value) {
    const currentLang = (0, _i18NextDefault.default).language || 'uk';
...
const resources = {
    uk: {
        translation: (0, _ukJsonDefault.default)
    },
    en: {
        translation: (0, _enJsonDefault.default)
    }
};
(0, _i18NextDefault.default).use((0, _i18NextBrowserLanguagedetectorDefault.default)).init({
    resources,
    fallbackLng: 'en',
    debug: false,
    interpolation: {
    ...
    document.dispatchEvent(new CustomEvent('i18n:ready', {
        detail: (0, _i18NextDefault.default).language.substring(0, 2)
    }));
});
function changeSiteLanguage(lng) {
    currentLengues = lng;
    return (0, _i18NextDefault.default).changeLanguage(lng).then(()=>{
        updateContent();
        const result = (0, _calculateResultJs.calculated)((0, _compliteDataToCanculateJs.data));
        (0, _buildTabel.buildTable)(result.yearlyHistory);
...
function updateContent() {
    document.querySelectorAll('[data-i18n]').forEach((element)=>{
        ...
        if (key.startsWith('[')) {
            ...
            element.setAttribute(attr, (0, _i18NextDefault.default).t(realKey));
        } else if (element.hasAttribute('data-i18n-options')) {
            const options = JSON.parse(element.getAttribute('data-i18n-options'));
            element.innerText = (0, _i18NextDefault.default).t(key, options);
        } else element.innerText = (0, _i18NextDefault.default).t(key);
    });
}
exports.default = (0, _i18NextDefault.default);

},{"i18next":"dBBdt","i18next-browser-languagedetector":"lceJn","../build/buildTabel":"l1Es6","../data/compliteDataToCanculate.js":"aNWHP","./calculateResult.js":"hWafh","../../langues/uk.json":"gIX2e","../../langues/en.json":"g4nT8","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dBBdt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "keyFromSelector", ()=>keysFromSelector);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lceJn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>Browser);
const { slice, forEach } = [];
...
var cookie$1 = {
    ...
    lookup (_ref) {
        ...
        if (lookupCookie && typeof document !== 'undefined') return cookie.read(lookupCookie) || undefined;
        return undefined;
    },
...
var localStorage = {
    ...
    lookup (_ref) {
        ...
        if (lookupLocalStorage && localStorageAvailable()) return window.localStorage.getItem(lookupLocalStorage) || undefined; // Undefined ensures type consistency with the previous version of this function
        return undefined;
    },
    // Deconstruct the options object and extract the lookupLocalStorage property
    cacheUserLanguage (lng, _ref2) {
...
var sessionStorage = {
    ...
    lookup (_ref) {
        ...
        if (lookupSessionStorage && sessionStorageAvailable()) return window.sessionStorage.getItem(lookupSessionStorage) || undefined;
        return undefined;
    },
    cacheUserLanguage (lng, _ref2) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"l1Es6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "buildTable", ()=>buildTable);
var _i18N = require("../operation/i18n");
...
function buildTable(array) {
    ...
    let html = array.map((obj)=>{
        const yearLabel = (0, _i18NDefault.default).t('table.year_count', {
            count: obj.year
        });
        return `<tr>
                    <td class="year-table__year">${yearLabel}</td>
                    <td>${(0, _i18N.formatNumber)(obj.startBalance)}</td>
                    <td>${(0, _i18N.formatNumber)(obj.contributionsMade)}</td>
                    <td class="year-table__interest">${(0, _i18N.formatNumber)(obj.interestEarned)}</td>
                    <td class="year-table__tax">${(0, _i18N.formatNumber)(obj.taxPaidThisYear)}</td>
                    <td class="year-table__final">${(0, _i18N.formatNumber)(obj.finalBalanceOfYear)}</td>
                </tr>`;
    });
    tabelToChange.innerHTML = html.join(" ");
}

},{"../operation/i18n":"81Dku","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"gIX2e":[function(require,module,exports,__globalThis) {
module.exports = JSON.parse('{"header":{"logo_subtitle":"\u041A\u0430\u043B\u044C\u043A\u0443\u043B\u044F\u0442\u043E\u0440 \u0441\u043A\u043B\u0430\u0434\u043D\u0438\u0445 \u0432\u0456\u0434\u0441\u043E\u0442\u043A\u0456\u0432","change_theme":"\u0417\u043C\u0456\u043D\u0438\u0442\u0438 \u0442\u0435\u043C\u0443"},"languages":{"ua":"\u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430","en":"English","es":"Espa\xf1ol","fr":"Fran\xe7ais"},"main":{"title":"\u041F\u043E\u0431\u0430\u0447\u0442\u0435, \u044F\u043A \u0440\u043E\u0441\u0442\u0443\u0442\u044C \u0432\u0430\u0448\u0456 \u0433\u0440\u043E\u0448\u0456","subtitle":"\u0422\u043E\u0447\u043D\u0438\u0439 \u043A\u0430\u043B\u044C\u043A\u0443\u043B\u044F\u0442\u043E\u0440 \u0441\u043A\u043B\u0430\u0434\u043D\u0438\u0445 \u0432\u0456\u0434\u0441\u043E\u0442\u043A\u0456\u0432. \u0417\u043C\u0456\u043D\u0456\u0442\u044C \u0431\u0443\u0434\u044C-\u044F\u043A\u0438\u0439 \u043F\u0430\u0440\u0430\u043C\u0435\u0442\u0440 \u2014 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u0438, \u0433\u0440\u0430\u0444\u0456\u043A \u0456 \u0442\u0430\u0431\u043B\u0438\u0446\u044E \u043E\u043D\u043E\u0432\u043B\u044E\u044E\u0442\u044C\u0441\u044F \u043C\u0438\u0442\u0442\u0454\u0432\u043E."},"form":{"title":"\u041F\u0430\u0440\u0430\u043C\u0435\u0442\u0440\u0438 \u0456\u043D\u0432\u0435\u0441\u0442\u0438\u0446\u0456\u0439","hint":"\u041D\u0430\u0442\u0438\u0441\u043D\u0456\u0442\u044C \xab\u0420\u043E\u0437\u0440\u0430\u0445\u0443\u0432\u0430\u0442\u0438\xbb, \u0449\u043E\u0431 \u043E\u043D\u043E\u0432\u0438\u0442\u0438 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u0438","initial_investment":"\u041F\u043E\u0447\u0430\u0442\u043A\u043E\u0432\u0456 \u0456\u043D\u0432\u0435\u0441\u0442\u0438\u0446\u0456\u0457","contribution":"\u0412\u043D\u0435\u0441\u043E\u043A","contribution_period":"\u041F\u0435\u0440\u0456\u043E\u0434\u0438\u0447\u043D\u0456\u0441\u0442\u044C \u0432\u043D\u0435\u0441\u043A\u0456\u0432","interest_rate":"\u041E\u0447\u0456\u043A\u0443\u0432\u0430\u043D\u0430 \u0432\u0456\u0434\u0441\u043E\u0442\u043A\u043E\u0432\u0430 \u0441\u0442\u0430\u0432\u043A\u0430","compounding_frequency":"\u0427\u0430\u0441\u0442\u043E\u0442\u0430 \u043D\u0430\u0440\u0430\u0445\u0443\u0432\u0430\u043D\u043D\u044F \u0432\u0456\u0434\u0441\u043E\u0442\u043A\u0443","term":"\u0422\u0435\u0440\u043C\u0456\u043D","inflation_rate":"\u041E\u0447\u0456\u043A\u0443\u0432\u0430\u043D\u0430 \u0456\u043D\u0444\u043B\u044F\u0446\u0456\u044F","tax_rate":"\u0421\u0442\u0430\u0432\u043A\u0430 \u043F\u043E\u0434\u0430\u0442\u043A\u0443","tax_timing":"\u041A\u043E\u043B\u0438 \u0441\u043F\u043B\u0430\u0447\u0443\u0432\u0430\u0442\u0438 \u043F\u043E\u0434\u0430\u0442\u043E\u043A","calculate_btn":"\u0420\u043E\u0437\u0440\u0430\u0445\u0443\u0432\u0430\u0442\u0438"},"periods":{"monthly":"\u0429\u043E\u043C\u0456\u0441\u044F\u0446\u044F","annual":"\u0429\u043E\u0440\u043E\u043A\u0443","at_the_end":"\u041D\u0430\u043F\u0440\u0438\u043A\u0456\u043D\u0446\u0456"},"results":{"total_before_tax":"\u0417\u0430\u0433\u0430\u043B\u044C\u043D\u0438\u0439 \u0431\u0430\u043B\u0430\u043D\u0441 \u0434\u043E \u043F\u043E\u0434\u0430\u0442\u043A\u0443","total_after_tax":"\u0411\u0430\u043B\u0430\u043D\u0441 \u043F\u0456\u0441\u043B\u044F \u043A\u0456\u043D\u0446\u0435\u0432\u043E\u0433\u043E \u043F\u043E\u0434\u0430\u0442\u043A\u0443","taxes_paid":"\u0421\u043F\u043B\u0430\u0447\u0435\u043D\u043E \u043F\u043E\u0434\u0430\u0442\u043A\u0456\u0432","total_contributions":"\u0417\u0430\u0433\u0430\u043B\u044C\u043D\u0438\u0439 \u0432\u043D\u0435\u0441\u043E\u043A","interest_earned":"\u0417\u0430\u0440\u043E\u0431\u043B\u0435\u043D\u0456 \u0432\u0456\u0434\u0441\u043E\u0442\u043A\u0438","adjusted_inflation":"\u041F\u0456\u0441\u043B\u044F \u0443\u0440\u0430\u0445\u0443\u0432\u0430\u043D\u043D\u044F \u0456\u043D\u0444\u043B\u044F\u0446\u0456\u0457"},"chart":{"title":"\u0417\u0440\u043E\u0441\u0442\u0430\u043D\u043D\u044F \u0432 \u0447\u0430\u0441\u0456","subtitle":"\u0412\u043D\u0435\u0441\u043E\u043A \u043F\u0440\u043E\u0442\u0438 \u0437\u0430\u0440\u043E\u0431\u043B\u0435\u043D\u0438\u0445 \u0432\u0456\u0434\u0441\u043E\u0442\u043A\u0456\u0432, \u0440\u0456\u043A \u0437\u0430 \u0440\u043E\u043A\u043E\u043C.","legend_contribution":"\u0412\u043D\u0435\u0441\u043E\u043A","legend_interest":"\u0412\u0456\u0434\u0441\u043E\u0442\u043A\u0438","legend_net_worth":"\u0427\u0438\u0441\u0442\u0438\u0439 \u043A\u0430\u043F\u0456\u0442\u0430\u043B"},"table":{"title":"\u0420\u043E\u0437\u0431\u0438\u0432\u043A\u0430 \u043F\u043E \u0440\u043E\u043A\u0430\u0445","subtitle":"\u0414\u0435\u0442\u0430\u043B\u044C\u043D\u0438\u0439 \u0437\u0432\u0456\u0442 \u043F\u0440\u043E \u0437\u0440\u043E\u0441\u0442\u0430\u043D\u043D\u044F \u043A\u0430\u043F\u0456\u0442\u0430\u043B\u0443.","th_year":"\u0420\u0456\u043A","th_initial_balance":"\u041F\u043E\u0447\u0430\u0442\u043A\u043E\u0432\u0438\u0439 \u0431\u0430\u043B\u0430\u043D\u0441","th_contributions":"\u0412\u043D\u0435\u0441\u043A\u0438","th_interest_earned":"\u0417\u0430\u0440\u043E\u0431\u043B\u0435\u043D\u0456 \u0432\u0456\u0434\u0441\u043E\u0442\u043A\u0438","th_tax":"\u041F\u043E\u0434\u0430\u0442\u043E\u043A","th_final_balance":"\u041A\u0456\u043D\u0446\u0435\u0432\u0438\u0439 \u0431\u0430\u043B\u0430\u043D\u0441","year_count":"\u0420\u0456\u043A {{count}}"},"years_suffix":"\u0440."}');

},{}],"g4nT8":[function(require,module,exports,__globalThis) {
module.exports = JSON.parse('{"header":{"logo_subtitle":"Compound Interest Calculator","change_theme":"Change theme"},"languages":{"ua":"\u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430","en":"English","es":"Espa\xf1ol","fr":"Fran\xe7ais"},"main":{"title":"Watch your money grow","subtitle":"Accurate compound interest calculator. Change any parameter \u2014 results, chart and table update instantly."},"form":{"title":"Investment Parameters","hint":"Click \\"Calculate\\" to update the results","initial_investment":"Initial Investment","contribution":"Contribution","contribution_period":"Contribution Frequency","interest_rate":"Expected Interest Rate","compounding_frequency":"Compounding Frequency","term":"Term","inflation_rate":"Expected Inflation","tax_rate":"Tax Rate","tax_timing":"When to Pay Tax","calculate_btn":"Calculate"},"periods":{"monthly":"Monthly","annual":"Annually","at_the_end":"At the end"},"results":{"total_before_tax":"Total Balance Before Tax","total_after_tax":"Balance After Final Tax","taxes_paid":"Taxes Paid","total_contributions":"Total Contributions","interest_earned":"Interest Earned","adjusted_inflation":"Adjusted for Inflation"},"chart":{"title":"Growth Over Time","subtitle":"Contributions vs. interest earned, year by year.","legend_contribution":"Contribution","legend_interest":"Interest","legend_net_worth":"Net Worth"},"table":{"title":"Annual Breakdown","subtitle":"Detailed capital growth report.","th_year":"Year","th_initial_balance":"Initial Balance","th_contributions":"Contributions","th_interest_earned":"Interest Earned","th_tax":"Tax","th_final_balance":"Final Balance","year_count":"Year {{count}}"},"years_suffix":"y."}');
...
dropDowns.forEach((dropDown)=>{
    ...
    if (actionBtn) actionBtn.addEventListener("click", toggleDropDown);
});
...
function changeDropDownValue(event) {
    ...
    if (selectedText === "EN") (0, _i18N.changeSiteLanguage)("en");
    else if (selectedText === "UA") (0, _i18N.changeSiteLanguage)("uk");
    // Оновлюємо стилі активного елемента в інтерфейсі
    if (currentDropDownSelectedItem) currentDropDownSelectedItem.classList.remove("dropdown__item--selected");
    currentDropDownItem.classList.add("dropdown__item--selected");
    if (dropDownValue) dropDownValue.textContent = selectedText;
...
document.addEventListener('i18n:ready', (event)=>{
    ...
    items.forEach((item)=>{
        ...
        if (itemType === displayFormat) item.classList.add("dropdown__item--selected");
        else item.classList.remove("dropdown__item--selected");
    });
});
...
},{"../operation/i18n":"81Dku","../build/buildTabel":"l1Es6","../build/buildGraphic":"81iWV"}],"81iWV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "currentArray", ()=>currentArray);
...
var _changeDataInBlancJs = require("../operation/changeDataInBlanc.js");
var _buildTabelJs = require("../build/buildTabel.js");
var _i18NJs = require("../operation/i18n.js");
var _i18NJsDefault = parcelHelpers.interopDefault(_i18NJs);
(0, _chartJs.Chart).register((0, _chartJs.CategoryScale), (0, _chartJs.LinearScale), (0, _chartJs.LineController), (0, _chartJs.LineElement), (0, _chartJs.PointElement), (0, _chartJs.Filler), (0, _chartJs.Tooltip));
...
function buildGraphic(event) {
    ...
    const result = (0, _calculateResultJs.calculated)((0, _compliteDataToCanculateJs.data));
    const labelsX = [
        (0, _i18NJsDefault.default).t('table.year_count', {
            count: 0
        })
    ];
    const vneskyArray = [
    ...
    result.yearlyHistory.forEach((item)=>{
        labelsX.push((0, _i18NJsDefault.default).t('table.year_count', {
            count: item.year
        }));
    ...
    growthChartInstance = new (0, _chartJs.Chart)(ctx, {
        type: 'line',
        data: {
            labels: labelsX,
            datasets: [
                {
                    label: (0, _i18NJsDefault.default).t('chart.legend_net_worth', {
                        defaultValue: "\u0427\u0438\u0441\u0442\u0438\u0439 \u043A\u0430\u043F\u0456\u0442\u0430\u043B"
                    }),
                    data: totalArray,
                    borderColor: '#10b981',
                    borderWidth: 2,
                ...
                {
                    label: (0, _i18NJsDefault.default).t('chart.legend_interest', {
                        defaultValue: "\u0412\u0456\u0434\u0441\u043E\u0442\u043A\u0438"
                    }),
                    data: vidsotkyArray,
                    borderColor: '#9333EA',
                ...
                {
                    label: (0, _i18NJsDefault.default).t('chart.legend_contribution', {
                        defaultValue: "\u0412\u043D\u0435\u0441\u043E\u043A"
                    }),
                    data: vneskyArray,
                    borderColor: '#6c757d',
    ...
    (0, _buildTabelJs.buildTable)(currentArray);
    (0, _changeDataInBlancJs.changeDataInBlanc)(result);
}
// Перемальовуємо графік при зміні мови сайту
document.addEventListener('i18n:languageChanged', ()=>{
    if (currentArray) buildGraphic();
});

},{"chart.js":"6U2cz","../data/compliteDataToCanculate.js":"aNWHP","../operation/calculateResult.js":"hWafh","./buildTooltip.js":"ejkOq","../operation/disableButton":"dxFi8","../operation/changeDataInBlanc.js":"fzkr2","../build/buildTabel.js":"l1Es6","../operation/i18n.js":"81Dku","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6U2cz":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v4.5.1
    ...
    if (tooltipModel.body) {
        ...
        if (tooltipEl.dataset.key !== dataKey) {
            ...
            tooltipModel.dataPoints.forEach((dataPoint, i)=>{
                ...
                const currentLang = (0, _i18NJsDefault.default).language || 'uk';
                const locale = currentLang.substring(0, 2) === 'uk' ? 'uk-UA' : 'en-US';
...
},{"../operation/i18n.js":"81Dku","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dxFi8":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jkSUj":[function(require,module,exports,__globalThis) {
...
const form = document.querySelector(".form-settings");
const submitBtn = document.querySelector(".form-settings__submit-btn");
if (form) form.addEventListener("input", renevalPage);
function renevalPage(event) {
    ...
    if (event.target.step === "0.1") {
        ...
        const suffix = (0, _i18NJsDefault.default).t('years_suffix', {
            defaultValue: "\u0440."
        });
        if (Number(event.target.value) >= 100) page.textContent = `100${suffix}`;
        else page.textContent = event.target.value + suffix;
    } else if (Number(event.target.value) >= 1000000) page.textContent = "1000000";
    else page.textContent = event.target.value;
    if (submitBtn) {
...
},{"../data/makeDataFromInput":"9Sc4T","./i18n.js":"81Dku","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9Sc4T":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./compliteDataToCanculate":"aNWHP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"l9oaf":[function(require,module,exports,__globalThis) {
module.exports = Promise.resolve(module.bundle.root("81iWV"));

},{"81iWV":"81iWV"}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequireeac2", {})
